...
gsdk = {
    ...
    checkScrollForBlueNavbar: debounce(function() {
        if($(document).scrollTop() > 260 ) {
            console.log('ok its 260 greater than now');
            if(transparent) {
                transparent = false;
                $('nav[role="navigation"]').addClass('navbar-kd-blue');
               // $('nav[role="navigation"]').addClass('small-nav-blue');
                $('nav[role="navigation"]').removeClass('navbar-white');
            }
        } else {
            if( !transparent ) {
                transparent = true;
                $('nav[role="navigation"]').removeClass('navbar-kd-blue');
                $('nav[role="navigation"]').addClass('navbar-white');
               // $('nav[role="navigation"]').removeClass('small-nav-blue');
